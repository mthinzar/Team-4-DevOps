...
// Add route tracking handler middleware inside your Express routes execution array
app.get('/track', (req, res) => {
    res.render('track', {
        images: {
            logo: '/images/logo.png' // Matches global context structure dependencies
        }
    });
});
...
app.post('/pay', (req, res) => {
    ...
    // 4. Charge successful: hand back an order number that the tracking system can use client-side
...
app.listen(PORT, () => {
    console.log(`FoodHub running beautifully on http://localhost:${PORT}`);
});
